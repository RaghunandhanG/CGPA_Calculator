...
if res:
            ...
            st.write(f'<h1> <span style="font-size:{additional_text_font_size};">Hi,</span><span style="font-size:{name_font_size}; color:{"black"};">{name}</span> <span style="font-size:{reg_no_font_size}; color:{reg_no_color};">{reg_no.replace('"' , "")}</span></h1>', unsafe_allow_html=True)
